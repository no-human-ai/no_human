...
const LAST = 5; // STEPS.length - 1 in Onboarding.jsx (Docs step left the wizard 2026-09-04; AI-history/rules steps left 2026-08-30; team step left 2026-08-09; Community step joined 2026-09-12); asserted against the real list below.
...
test("the wizard's STEPS list really has lastIndex 5, so these cases are the real ones", () => {
