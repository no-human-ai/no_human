...
MECHANISMS: list[tuple[str, tuple[str, ...], str]] = [
    ...
    ("pr_watch_ladder",
     ("merged", "pr_closed", "pr_feedback", "pr_feedback_skipped",
      ...
      # above. Same trap the 2026-08-07 comment below describes — this list
      # is hardcoded and events land here by nothing but a human adding
      # them, so these two are added at the same time the events were
