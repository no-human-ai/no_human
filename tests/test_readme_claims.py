...
CITATION_TABLE = (
    ...
    ("security.md", "vcs/pr_watcher.py:default_pr_state", "vcs/pr_watcher.py",
     '"gh", "pr", "view"'),
    ("security.md", "vcs/git.py:GitRepo._have_remote_commit:1059", "vcs/git.py",
     '"git", "fetch"'),
    ("security.md", ":GitRepo.fetch:1393", "vcs/git.py", '["fetch", remote]'),
    ("security.md", "cli/commands.py:merge_stack_run:2940", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5160", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7717",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:7868", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:7746", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
