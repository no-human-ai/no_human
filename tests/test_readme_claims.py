...
CITATION_TABLE = (
    ...
    ("security.md", "cli/commands.py:merge_stack_run:3181", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5429", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7986",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:8137", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:8015", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
