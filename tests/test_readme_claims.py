...
CITATION_TABLE = (
    ...
    ("security.md", "desktop/main.mjs:1220", "desktop/main.mjs", "checkForUpdates()"),
    ("security.md", "desktop/electron-builder.config.cjs:388",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7735",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:7886", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:7764", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
