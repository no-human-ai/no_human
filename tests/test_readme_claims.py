...
CITATION_TABLE = (
    ...
    ("security.md", "cli/commands.py:merge_stack_run:3061", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5296", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7853",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:8004", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:7882", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
