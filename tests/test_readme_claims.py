...
CITATION_TABLE = (
    ...
    ("security.md", "vcs/git.py:GitRepo._have_remote_commit:1185", "vcs/git.py",
     '"git", "fetch"'),
    ("security.md", ":GitRepo.fetch:1548", "vcs/git.py", '["fetch", remote]'),
    ("security.md", "cli/commands.py:merge_stack_run:3112", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5360", "cli/commands.py",
     '_refuse_agent_gate_act("approve")'),
    ("security.md", ":merge_stack_run:3082", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:7917",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:8068", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:7946", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
