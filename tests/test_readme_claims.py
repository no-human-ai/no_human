...
CITATION_TABLE = (
    ...
    ("security.md", "vcs/pr_watcher.py:default_pr_state", "vcs/pr_watcher.py",
     '"gh", "pr", "view"'),
    ("security.md", "vcs/git.py:GitRepo._have_remote_commit:1222", "vcs/git.py",
     '"git", "fetch"'),
    ("security.md", ":GitRepo.fetch:1558", "vcs/git.py", '["fetch", remote]'),
    ("security.md", "cli/commands.py:merge_stack_run:3193", "cli/commands.py",
     '"gh", "pr", "merge"'),
    ("security.md", "cli/commands.py:approve:5455", "cli/commands.py",
     '_refuse_agent_gate_act("approve")'),
    ("security.md", ":merge_stack_run:3163", "cli/commands.py",
    ...
    ("security.md", "history/extractor.py:65-72", "history/extractor.py",
     "csrf_token"),
    # docs/eval.md
    ("eval.md", "src/no_human/cli/commands.py:bench_run:8022",
     "src/no_human/cli/commands.py", "different --trials are not resumed"),
    ("eval.md", ":bench_run:8173", "src/no_human/cli/commands.py", "asyncio.gather"),
    ("eval.md", ":bench_run:8051", "src/no_human/cli/commands.py",
     "(sc.task_id, sc.trial)"),
