...
FROZEN_FILE_LINES = {
    ...
    # scanner below.
    # 25039 -> 25061 (+22): attempt-process-reaper fix (the 36-orphan
    # `while True: pass` incident) -- `_run_attempt` split into a thin
    # header (`attempt_procs.attempt_scope(...)` around a delegate call)
    # and `_run_attempt_inner` (the original body, moved verbatim), plus
    # the header's explanatory comment. See `core/attempt_procs.py`.
    "core/orchestrator.py": 25061,
